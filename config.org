...
* packages and use-package bootstrapping

** Setting up the packaging system
...
** Bootstrapping use-package
   use-package is an amazing frontend to the package manager, and I use it heavily
...
#+END_SRC
** Set up auto-updating for my packages
#+BEGIN_SRC emacs-lisp tangle: yes
  ...
  (setq
   ...
   '(
     ...
     ("T" "Tickler" entry
      ...
      "* %i%? \n %U")
     ("p" "Project" entry
      (file+headline (concat org-directory "gtd.org") "Projects")
      "* %i%? :project: \n ")
     ...
     ("jl" "Today I Learned" entry ; Breif TIL journal entry
      (file+datetree (concat org-directory "journal.org") "TIL")
      "* %?\nLearned on %U :til:\n  %i\n  %a")
