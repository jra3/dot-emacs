...
#+BEGIN_SRC emacs-lisp tangle: yes
  ...
  (use-package lsp-mode
    :commands lsp
    :config
    (setq xref-prompt-for-identifier '(not
  ...
  (use-package company-lsp
    ...
    ;; (setq company-lsp-enable-snippet t ;; wut
    ;;       company-transformers nil ;; wut
    ;;       company-lsp-async t ;; probs good
    ;;       company-lsp-cache-candidates nil ;; nil or t?
