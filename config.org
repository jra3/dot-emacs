...
#+BEGIN_SRC emacs-lisp tangle: yes
  ...
  (setq find-file-visit-truename t) ; hack hates symlinks
  (require 'lsp-hack)

  ;; (add-hook 'hack-mode-hook #'lsp-hack-enable) ; such alpha
#+END_SRC
...
** Hack
#+BEGIN_SRC emacs-lisp tangle: yes
  (add-hook 'hack-mode-hook (lambda () (company-mode t) (message "%s" major-mode)) 'append)
#+END_SRC
