...
#+begin_src emacs-lisp :tangle yes
  ...
  (defun org-task-open (id)
    "Open the task in the browser."
    (browse-url (concat "https://our.intern.facebook.com/intern/tasks?t="
                        (string-remove-prefix "T" id))))

  ;x (defun org-insert-task-link (id)
  ;   (let ((desc ))
  ;   (org-insert-link nil (concat "task:" (string-remove-prefix "T" id)) "dazzle"))
#+end_src
* Snippets
