...
#+begin_src emacs-lisp :tangle yes
  ...
  (defun org-save-regular-buffers ()
  ...
  (add-hook 'org-agenda-mode-hook
            (lambda ()
              (define-key org-agenda-mode-map "s" 'org-save-regular-buffers)
              ...
              (add-hook 'auto-save-hook 'org-save-regular-buffers nil t)
              (auto-save-mode)))
#+end_src
                ...
                '(("C" "Clarify"
                  ...
                  (" " "Agenda"
                   ((agenda "" ((org-agenda-overriding-header "Today's Schedule:")
                    ...
                    (agenda "" ((org-agenda-overriding-header "Habits and Chores:")
...
#+BEGIN_SRC emacs-lisp :tangle yes
  ...
  (defvar org-clocking-luxafor-break-over-pattern 'yellow
    "Luxafor pattern to use for 'org-mode' clock-out.")
